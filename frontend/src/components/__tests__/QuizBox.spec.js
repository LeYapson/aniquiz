...
describe('App Quiz Logic', () => {
  ...
  it('affiche le bouton de lancement quand on est en LOBBY', async () => {
    const wrapper = mount(App, {
      global: {
        stubs: { RoomSelection: true, GameTimer: true, AuthForm: true, LandingPage: true, LeaderboardPage: true, ProfilePage: true, ChatPanel: true, AppHeader: true, HomeDashboard: true, AppFooter: true },
      },
    })
